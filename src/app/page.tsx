...
export default function Home() {
    ...
    return (
        <div className="flex flex-col justify-center items-center w-screen flex-1 fixed mt-32">
            <div className="flex flex-col justify-start gap-8 items-center w-1/3 text-center">
                <h1 className="text-7xl font-semibold"> Pave the way for an easy day! </h1>
                ...
                <Image
                    ...
                    width={400} height={400} alt={"Image of car"} />
            </div>
        </div>
    )
}
