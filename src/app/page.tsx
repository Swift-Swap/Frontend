    ...
    <div className="flex flex-col justify-center items-center w-screen flex-1 p-2">
      <div className="flex flex-col justify-start md:w-2/3 gap-8 items-center w-full text-center">
        ...
        <p className="text-muted-foreground text-lg">
          ...
          efficiently and conveniently. We aim to alleviate parking congestion
          by encouraging voluntary student spot exchanges.
        </p>
        <div className="flex gap-4">
          ...
          <Link href={`${isSignedIn ? "/contact" : "/about"}`}>
            <Button
              className="text-xl p-6 px-12 flex gap-4 items-center"
              variant="outline"
            >
              {`${isSignedIn ? "Contact" : "About"}`}
            </Button>
          </Link>
        </div>
        <Image
