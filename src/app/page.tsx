...
export default function Home() {
    ...
    return (
        <div className="flex flex-col justify-center items-center w-screen flex-1">
            <div className="flex flex-col justify-start gap-8 items-center w-1/3 text-center mt-24">
                <h1 className="text-6xl font-semibold"> Pave the way for an easy day! </h1>
