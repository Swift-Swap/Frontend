                    ...
                    <TableBody>
                        {recent.map((l) => (
                            <TableRow key={l.spaceid}>
                                <TableCell className="font-medium">${convertToPrice(parseSplitDate(l.start_date), parseSplitDate(l.end_date))}</TableCell>
                                <TableCell>#{formatNumber(l.spotnumber)}</TableCell>
                                <TableCell className="text-center">{l.lot}</TableCell>
                                <TableCell className="text-right">{format(parseSplitDate(l.date_bought), "MM/dd/yyyy")}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
